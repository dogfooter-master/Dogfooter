...
class LYBConstant():
    LYB_USAGE = '. 홈페이지 주소는 www.dogfooter.com 입니다.                          \n' \
                ...
                '. 앱플레이어 창 사이즈를 가로x세로(800x450)으로 설정해야 인식됩니다. \n' \
                '. DPI는 120으로 설정해야 합니다.                                     \n' \
    ...
    LYB_GAME_CLANS = '클랜즈'
    LYB_GAME_DATA_CLANS = 'clans'
    LYB_GAME_L2R = '리니지2레볼루션'
    LYB_GAME_DATA_L2R = 'l2r'
    LYB_GAME_TERA = '테라M'
    LYB_GAME_DATA_TERA = 'tera'
    LYB_GAME_YEOLHYUL = '열혈강호M'
    LYB_GAME_DATA_YEOLHYUL = 'yeolhyul'
    LYB_GAME_BLACKDESERT = '검은사막M'
    LYB_GAME_DATA_BLACKDESERT = 'blackdesert'
    LYB_GAME_MIRACLE = '미라클'
    LYB_GAME_DATA_MIRACLE = 'miracle'
    LYB_GAME_KAISER = '카이저'
    LYB_GAME_DATA_KAISER = 'kaiser'
    LYB_GAME_MU2 = '뮤오리진2'
    LYB_GAME_DATA_MU2 = 'mu2'
    LYB_GAME_BLADE2 = '블레이드2'
    LYB_GAME_DATA_BLADE2 = 'blade2'
    LYB_GAME_ICARUS = '이카루스M'
    LYB_GAME_DATA_ICARUS = 'icarus'
    LYB_GAME_COC = 'COC'
    LYB_GAME_DATA_COC = 'coc'
    LYB_GAME_TALION = '탈리온'
    LYB_GAME_DATA_TALION = 'talion'
    LYB_GAME_LINM = '리니지M'
    LYB_GAME_DATA_LINM = 'linm'
    LYB_GAME_DARKEDEN = '다크에덴M'
    LYB_GAME_DATA_DARKEDEN = 'darkeden'
    LYB_GAME_HUNDREDSOUL = '헌드레드소울'
    LYB_GAME_DATA_HUNDREDSOUL = 'hundredsoul'
    LYB_GAME_ROHAN = '로한M'
    LYB_GAME_DATA_ROHAN = 'rohan'

    LYB_GAMES = {
        LYB_GAME_ROHAN: LYB_GAME_DATA_ROHAN,
    }
    ...
    LYB_DO_PREFIX = 'do_'
    LYB_YH_PREFIX = 'yh_'
    LYB_CLANS_PREFIX = 'clans_'
    LYB_BD_PREFIX = 'bd_'
    LYB_MIRACLE_PREFIX = 'miracle_'
    LYB_KAISER_PREFIX = 'kaiser_'
    LYB_MU2_PREFIX = 'mu2_'
    LYB_BLADE2_PREFIX = 'blade_'
    LYB_L2R_PREFIX = 'l2r_'
    LYB_ICARUS_PREFIX = 'icarus_'
    LYB_COC_PREFIX = 'coc_'
    LYB_TALION_PREFIX = 'talion_'
    LYB_LINM_PREFIX = 'linm_'
    LYB_DARKEDEN_PREFIX = 'darkeden_'
    LYB_HUNDREDSOUL_PREFIX = 'hundredsoul_'
    LYB_ROHAN_PREFIX = 'rohan_'
    ...
    LYB_TOOLTIP_TELEGRAM = '\n' \
                           ...
                           '2. 텔레그램 대화 상대에서 "@DogFooter 를 검색하세요.\n' \
    ...
    LYB_DO_STRING_BD_THRESHOLD = LYB_DO_PREFIX + LYB_BD_PREFIX + 'threshold_stringvar_'
    LYB_DO_STRING_BD_PERIOD = LYB_DO_PREFIX + LYB_BD_PREFIX + 'period_stringvar_'
    LYB_DO_STRING_BD_HUNT = LYB_DO_PREFIX + LYB_BD_PREFIX + 'hunt_stringvar_'
    LYB_DO_STRING_BD_WORK = LYB_DO_PREFIX + LYB_BD_PREFIX + 'work_stringvar_'
    LYB_DO_STRING_BD_WORK2 = LYB_DO_PREFIX + LYB_BD_PREFIX + 'work2_stringvar_'
    LYB_DO_STRING_BD_DDOLMANI_SKILL = LYB_DO_PREFIX + LYB_BD_PREFIX + 'ddolmani_skill_stringvar_'
    LYB_DO_STRING_BD_PET = LYB_DO_PREFIX + LYB_BD_PREFIX + 'pet_stringvar_'
    LYB_DO_STRING_BD_NOTIFY = LYB_DO_PREFIX + LYB_BD_PREFIX + 'notify_stringvar_'
    LYB_DO_STRING_BD_TOBEOL = LYB_DO_PREFIX + LYB_BD_PREFIX + 'tobeol_config_'

    LYB_DO_STRING_YH_THRESHOLD_NEXT = LYB_DO_PREFIX + LYB_YH_PREFIX + 'threshold_next_stringvar'
    LYB_DO_STRING_YH_THRESHOLD_GATE = LYB_DO_PREFIX + LYB_YH_PREFIX + 'threshold_gate_stringvar'

    LYB_DO_STRING_MIRACLE_WORK = LYB_DO_PREFIX + LYB_MIRACLE_PREFIX + 'work_'
    LYB_DO_STRING_MIRACLE_CONFIG = LYB_DO_PREFIX + LYB_MIRACLE_PREFIX + 'config_'

    LYB_DO_STRING_KAISER_WORK = LYB_DO_PREFIX + LYB_KAISER_PREFIX + 'work_'
    LYB_DO_STRING_KAISER_CONFIG = LYB_DO_PREFIX + LYB_KAISER_PREFIX + 'config_'
    LYB_DO_STRING_KAISER_NOTIFY = LYB_DO_PREFIX + LYB_KAISER_PREFIX + 'notify_'

    LYB_DO_STRING_MU2_WORK = LYB_DO_PREFIX + LYB_MU2_PREFIX + 'work_'
    LYB_DO_STRING_MU2_CONFIG = LYB_DO_PREFIX + LYB_MU2_PREFIX + 'config_'

    LYB_DO_STRING_BLADE2_WORK = LYB_DO_PREFIX + LYB_BLADE2_PREFIX + 'work_'
    LYB_DO_STRING_BLADE2_NOTIFY = LYB_DO_PREFIX + LYB_BLADE2_PREFIX + 'notify_'

    LYB_DO_STRING_L2R_WORK = LYB_DO_PREFIX + LYB_L2R_PREFIX + 'work_'
    LYB_DO_STRING_L2R_NOTIFY = LYB_DO_PREFIX + LYB_L2R_PREFIX + 'notify_'
    LYB_DO_STRING_L2R_ETC = LYB_DO_PREFIX + LYB_L2R_PREFIX + 'etc_'

    LYB_DO_STRING_ICARUS_WORK = LYB_DO_PREFIX + LYB_ICARUS_PREFIX + 'work_'
    LYB_DO_STRING_ICARUS_NOTIFY = LYB_DO_PREFIX + LYB_ICARUS_PREFIX + 'notify_'
    LYB_DO_STRING_ICARUS_ETC = LYB_DO_PREFIX + LYB_ICARUS_PREFIX + 'etc_'

    LYB_DO_STRING_TALION_WORK = LYB_DO_PREFIX + LYB_TALION_PREFIX + 'work_'
    LYB_DO_STRING_TALION_NOTIFY = LYB_DO_PREFIX + LYB_TALION_PREFIX + 'notify_'
    LYB_DO_STRING_TALION_ETC = LYB_DO_PREFIX + LYB_TALION_PREFIX + 'etc_'

    LYB_DO_STRING_LINM_WORK = LYB_DO_PREFIX + LYB_LINM_PREFIX + 'work_'
    LYB_DO_STRING_LINM_NOTIFY = LYB_DO_PREFIX + LYB_LINM_PREFIX + 'notify_'
    LYB_DO_STRING_LINM_ETC = LYB_DO_PREFIX + LYB_LINM_PREFIX + 'etc_'

    LYB_DO_STRING_DARKEDEN_WORK = LYB_DO_PREFIX + LYB_DARKEDEN_PREFIX + 'work_'
    LYB_DO_STRING_DARKEDEN_NOTIFY = LYB_DO_PREFIX + LYB_DARKEDEN_PREFIX + 'notify_'
    LYB_DO_STRING_DARKEDEN_ETC = LYB_DO_PREFIX + LYB_DARKEDEN_PREFIX + 'etc_'

    LYB_DO_STRING_HUNDREDSOUL_WORK = LYB_DO_PREFIX + LYB_HUNDREDSOUL_PREFIX + 'work_'
    LYB_DO_STRING_HUNDREDSOUL_NOTIFY = LYB_DO_PREFIX + LYB_HUNDREDSOUL_PREFIX + 'notify_'
    LYB_DO_STRING_HUNDREDSOUL_ETC = LYB_DO_PREFIX + LYB_HUNDREDSOUL_PREFIX + 'etc_'

    LYB_DO_STRING_ROHAN_WORK = LYB_DO_PREFIX + LYB_ROHAN_PREFIX + 'work_'
    LYB_DO_STRING_ROHAN_NOTIFY = LYB_DO_PREFIX + LYB_ROHAN_PREFIX + 'notify_'
    LYB_DO_STRING_ROHAN_ETC = LYB_DO_PREFIX + LYB_ROHAN_PREFIX + 'etc_'

    LYB_DO_CLANS_BOOLEAN_GIBODANG_ITEM = LYB_DO_PREFIX + LYB_CLANS_PREFIX + 'gibodang_item_booleanvar_'
    LYB_DO_CLANS_STRING_DURATION_JASA = LYB_DO_PREFIX + LYB_CLANS_PREFIX + 'duration_jasa_stringvar'
    LYB_DO_CLANS_STRING_DURATION_SAFETY_MOVE = LYB_DO_PREFIX + LYB_CLANS_PREFIX + 'duration_safety_move_stringvar'
    LYB_DO_CLANS_STRING_DURATION_SANGDAN = LYB_DO_PREFIX + LYB_CLANS_PREFIX + 'duration_sangdan_stringvar'
    LYB_DO_CLANS_STRING_SANGDAN_ITEM = LYB_DO_PREFIX + LYB_CLANS_PREFIX + 'sangdan_item_stringvar_'
